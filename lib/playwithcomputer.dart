...
class play_with_comp extends StatefulWidget {
  @override
  _play_with_compState createState() => new _play_with_compState();
}

class _play_with_compState extends State<play_with_comp> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text("(Single Player Mode)"),
        ),
        body:
        ...
        new Stack(
            ...
            children: [
        new Image(
        image: new AssetImage("assets/pic6.jpg"),
      fit:BoxFit.cover,
        ...
        new Column(
          ...
          children: <Widget>[
            ...
            new Container(
              ...
              child: new RaisedButton(
                child: new Text("Return To Home Page"),
